...
module.exports = [
    {
        ...
        handler: async (request, h) => {
            ...
            await mailService.sendEmail(request.payload.email, 'Bienvenue', 'Bienvenue sur notre site');
        ...
        options: {
            ...
            validate: {
                ...
                payload: Joi.object({
                    ...
                    roles: Joi.array().items(Joi.string()).example(['admin']).description('Roles of the user')
                })
            }
        },
        handler: async (request, h) => {
